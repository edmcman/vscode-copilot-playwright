...
class Constants:
    ...
    SELECTOR_SEND_BUTTON = 'a.action-label.codicon[aria-label^="Send"]'
    SELECTOR_SEND_BUTTON_ENABLED = 'a.action-label.codicon[aria-label^="Send"]:not(.disabled)'
    ...
    SELECTOR_QUESTION_TITLE = '.chat-question-title'
    SELECTOR_QUESTION_OPTION = '.chat-question-list-item'
    SELECTOR_QUESTION_OPTION_TITLE = '.chat-question-list-label-title'
    SELECTOR_QUESTION_OPTION_DESC = '.chat-question-list-label-desc'
    SELECTOR_QUESTION_FREEFORM = 'textarea.chat-question-freeform-textarea'
    SELECTOR_QUESTION_SUBMIT_BUTTON = 'a.chat-question-nav-submit'
    SELECTOR_QUESTION_CLOSE_BUTTON = 'a.chat-question-close'
